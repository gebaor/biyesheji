...
--
-- Host: localhost    Database: springboot13f8n
-- ------------------------------------------------------
...
--
-- Current Database: `springboot13f8n`
--

/*!40000 DROP DATABASE IF EXISTS `springboot13f8n`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `springboot13f8n` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
INSERT INTO `address` VALUES (1,'2024-03-07 07:14:30',11,'宇宙银河系金星1号','金某','13823888881','是'),(2,'2024-03-07 07:14:30',12,'宇宙银河系木星1号','木某','13823888882','是'),(3,'2024-03-07 07:14:30',13,'宇宙银河系水星1号','水某','13823888883','是'),(4,'2024-03-07 07:14:30',14,'宇宙银河系火星1号','火某','13823888884','是'),(5,'2024-03-07 07:14:30',15,'宇宙银河系土星1号','土某','13823888885','是'),(6,'2024-03-07 07:14:30',16,'宇宙银河系月球1号','月某','13823888886','是'),(7,'2024-03-07 07:14:30',17,'宇宙银河系黑洞1号','黑某','13823888887','是'),(8,'2024-03-07 07:14:30',18,'宇宙银河系地球1号','地某','13823888888','是');
...
CREATE TABLE `cart` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `tablename` varchar(200) DEFAULT 'shangpinxinxi' COMMENT '地摊表名',
  `userid` bigint(20) NOT NULL COMMENT '用户id',
  `goodid` bigint(20) NOT NULL COMMENT '地摊id',
  `goodname` varchar(200) DEFAULT NULL COMMENT '地摊名称',
...
INSERT INTO `chat` VALUES (41,'2024-03-07 07:14:30',1,1,'提问1','回复1',1),(42,'2024-03-07 07:14:30',2,2,'提问2','回复2',2),(43,'2024-03-07 07:14:30',3,3,'提问3','回复3',3),(44,'2024-03-07 07:14:30',4,4,'提问4','回复4',4),(45,'2024-03-07 07:14:30',5,5,'提问5','回复5',5),(46,'2024-03-07 07:14:30',6,6,'提问6','回复6',6),(47,'2024-03-07 07:14:30',7,7,'提问7','回复7',7),(48,'2024-03-07 07:14:30',8,8,'提问8','回复8',8);
...
CREATE TABLE `discussshangpinxinxi` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='地摊信息评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='地摊公告';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `orderid` varchar(200) NOT NULL COMMENT '摊位编号',
  `tablename` varchar(200) DEFAULT 'shangpinxinxi' COMMENT '地摊表名',
  `userid` bigint(20) NOT NULL COMMENT '用户id',
  `goodid` bigint(20) NOT NULL COMMENT '地摊id',
  `goodname` varchar(200) DEFAULT NULL COMMENT '地摊名称',
  `picture` longtext COMMENT '地摊图片',
  `buynumber` int(11) NOT NULL COMMENT '购买数量',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='摊位';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shangpinfenlei` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `shangpinfenlei` varchar(200) NOT NULL COMMENT '地摊分类',
  PRIMARY KEY (`id`),
  UNIQUE KEY `shangpinfenlei` (`shangpinfenlei`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='地摊分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shangpinfenlei` VALUES (21,'2024-03-07 07:14:30','地摊分类1'),(22,'2024-03-07 07:14:30','地摊分类2'),(23,'2024-03-07 07:14:30','地摊分类3'),(24,'2024-03-07 07:14:30','地摊分类4'),(25,'2024-03-07 07:14:30','地摊分类5'),(26,'2024-03-07 07:14:30','地摊分类6'),(27,'2024-03-07 07:14:30','地摊分类7'),(28,'2024-03-07 07:14:30','地摊分类8');
...
CREATE TABLE `shangpinxinxi` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `shangpinmingcheng` varchar(200) NOT NULL COMMENT '地摊名称',
  `shangpinfenlei` varchar(200) NOT NULL COMMENT '地摊分类',
  `tupian` longtext COMMENT '图片',
  `guige` varchar(200) DEFAULT NULL COMMENT '规格',
  `chandi` varchar(200) DEFAULT NULL COMMENT '产地',
  `shangpinxiangqing` longtext COMMENT '地摊详情',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='地摊信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shangpinxinxi` VALUES (31,'2024-03-07 07:14:30','地摊名称1','地摊分类1','upload/shangpinxinxi_tupian1.jpg,upload/shangpinxinxi_tupian2.jpg,upload/shangpinxinxi_tupian3.jpg','规格1','产地1','地摊详情1',1,99,'2024-03-07 15:14:30',1,99.9),(32,'2024-03-07 07:14:30','地摊名称2','地摊分类2','upload/shangpinxinxi_tupian2.jpg,upload/shangpinxinxi_tupian3.jpg,upload/shangpinxinxi_tupian4.jpg','规格2','产地2','地摊详情2',2,99,'2024-03-07 15:14:30',2,99.9),(33,'2024-03-07 07:14:30','地摊名称3','地摊分类3','upload/shangpinxinxi_tupian3.jpg,upload/shangpinxinxi_tupian4.jpg,upload/shangpinxinxi_tupian5.jpg','规格3','产地3','地摊详情3',3,99,'2024-03-07 15:14:30',3,99.9),(34,'2024-03-07 07:14:30','地摊名称4','地摊分类4','upload/shangpinxinxi_tupian4.jpg,upload/shangpinxinxi_tupian5.jpg,upload/shangpinxinxi_tupian6.jpg','规格4','产地4','地摊详情4',4,99,'2024-03-07 15:14:30',4,99.9),(35,'2024-03-07 07:14:30','地摊名称5','地摊分类5','upload/shangpinxinxi_tupian5.jpg,upload/shangpinxinxi_tupian6.jpg,upload/shangpinxinxi_tupian7.jpg','规格5','产地5','地摊详情5',5,99,'2024-03-07 15:14:30',5,99.9),(36,'2024-03-07 07:14:30','地摊名称6','地摊分类6','upload/shangpinxinxi_tupian6.jpg,upload/shangpinxinxi_tupian7.jpg,upload/shangpinxinxi_tupian8.jpg','规格6','产地6','地摊详情6',6,99,'2024-03-07 15:14:30',6,99.9),(37,'2024-03-07 07:14:30','地摊名称7','地摊分类7','upload/shangpinxinxi_tupian7.jpg,upload/shangpinxinxi_tupian8.jpg,upload/shangpinxinxi_tupian9.jpg','规格7','产地7','地摊详情7',7,99,'2024-03-07 15:14:30',7,99.9),(38,'2024-03-07 07:14:30','地摊名称8','地摊分类8','upload/shangpinxinxi_tupian8.jpg,upload/shangpinxinxi_tupian9.jpg,upload/shangpinxinxi_tupian10.jpg','规格8','产地8','地摊详情8',8,99,'2024-03-07 15:14:30',8,99.9);
...
CREATE TABLE `storeup` (
  ...
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `userid` bigint(20) NOT NULL COMMENT '用户id',
  `refid` bigint(20) DEFAULT NULL COMMENT '地摊id',
...
INSERT INTO `users` VALUES (1,'admin','admin','管理员','2024-03-07 07:14:30');
...
INSERT INTO `yonghu` VALUES (11,'2024-03-07 07:14:30','用户名1','123456','姓名1','upload/yonghu_touxiang1.jpg','男','13823888881','773890001@qq.com',200),(12,'2024-03-07 07:14:30','用户名2','123456','姓名2','upload/yonghu_touxiang2.jpg','男','13823888882','773890002@qq.com',200),(13,'2024-03-07 07:14:30','用户名3','123456','姓名3','upload/yonghu_touxiang3.jpg','男','13823888883','773890003@qq.com',200),(14,'2024-03-07 07:14:30','用户名4','123456','姓名4','upload/yonghu_touxiang4.jpg','男','13823888884','773890004@qq.com',200),(15,'2024-03-07 07:14:30','用户名5','123456','姓名5','upload/yonghu_touxiang5.jpg','男','13823888885','773890005@qq.com',200),(16,'2024-03-07 07:14:30','用户名6','123456','姓名6','upload/yonghu_touxiang6.jpg','男','13823888886','773890006@qq.com',200),(17,'2024-03-07 07:14:30','用户名7','123456','姓名7','upload/yonghu_touxiang7.jpg','男','13823888887','773890007@qq.com',200),(18,'2024-03-07 07:14:30','用户名8','123456','姓名8','upload/yonghu_touxiang8.jpg','男','13823888888','773890008@qq.com',200);
...
-- Dump completed on 2024-03-07 15:16:11
