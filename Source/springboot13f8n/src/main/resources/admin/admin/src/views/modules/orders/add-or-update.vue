<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="摊位编号" prop="orderid">
            <el-input v-model="ruleForm.orderid" 
                placeholder="摊位编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.orderid" label="摊位编号" prop="orderid">
              <el-input v-model="ruleForm.orderid" 
                placeholder="摊位编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="地摊名称" prop="goodname">
          <el-input v-model="ruleForm.goodname" 
              placeholder="地摊名称" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="地摊名称" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="地摊图片" prop="picture">
          <file-upload
          tip="点击上传地摊图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="地摊图片" prop="picture">
...
export default {
  data() {
	...
	remark : false,
      ...
      rules: {
          orderid: [
                { required: true, message: '摊位编号不能为空', trigger: 'blur' },
          ],
          tablename: [
          ],
          userid: [
          ...
          goodid: [
                { required: true, message: '地摊id不能为空', trigger: 'blur' },
          ],
          goodname: [
          ],
          picture: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.remark = true;
            ...
            this.statusOptions = "未支付,已支付,已完成,已取消,已退款,已下单".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springboot13f8n/upload');
        } else {
