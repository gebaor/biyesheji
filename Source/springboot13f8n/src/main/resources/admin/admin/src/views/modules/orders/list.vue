    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                <el-form-item :label="contents.inputTitle == 1 ? '摊位编号' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.orderid" placeholder="摊位编号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.orderid" placeholder="摊位编号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.orderid" placeholder="摊位编号" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '地摊名称' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.goodname" placeholder="地摊名称" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.goodname" placeholder="地摊名称" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.goodname" placeholder="地摊名称" clearable></el-input>
                </el-form-item>
          <el-form-item>
	    ...
	    <download-excel v-if="isAuth('orders'+'/'+orderStatus,'导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "摊位.xls">
		      <!-- 导出excel -->
            	<el-button
            ...
            >{{ contents.btnAdAllFont == 1?'地摊销量':'' }}</el-button>
            <el-button
              v-if="isAuth('orders'+'/'+orderStatus,'品销量') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
              type="warning"
              @click="goodnameNumberChartDialog()"
            >{{ contents.btnAdAllFont == 1?'地摊销量':'' }}<i class="el-icon-s-data el-icon--right" /></el-button>
            <el-button
            ...
            >{{ contents.btnAdAllFont == 1?'地摊销额':'' }}</el-button>
            <el-button
              v-if="isAuth('orders'+'/'+orderStatus,'品销额') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
              type="warning"
              @click="goodnameAmountChartDialog()"
            >{{ contents.btnAdAllFont == 1?'地摊销额':'' }}<i class="el-icon-s-data el-icon--right" /></el-button>
            <el-button
		...
		<el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign" 
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'下单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="primary" icon="el-icon-edit" size="mini" @click="updateHandler(scope.row)">{{ contents.tableBtnFont == 1?'下单':'' }}</el-button>
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'下单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="primary" size="mini" @click="updateHandler(scope.row)">{{ contents.tableBtnFont == 1?'下单':'' }}<i class="el-icon-edit el-icon--right" /></el-button>
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'下单') && contents.tableBtnIcon == 0" type="primary" size="mini" @click="updateHandler(scope.row)">{{ contents.tableBtnFont == 1?'下单':'' }}</el-button>
