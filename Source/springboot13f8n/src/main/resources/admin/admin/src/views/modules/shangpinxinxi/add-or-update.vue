<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="地摊名称" prop="shangpinmingcheng">
          <el-input v-model="ruleForm.shangpinmingcheng" 
              placeholder="地摊名称" clearable  :readonly="ro.shangpinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="地摊名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="地摊名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="地摊分类" prop="shangpinfenlei">
          <el-select :disabled="ro.shangpinfenlei" v-model="ruleForm.shangpinfenlei" placeholder="请选择地摊分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="地摊分类" prop="shangpinfenlei">
	      <el-input v-model="ruleForm.shangpinfenlei"
                placeholder="地摊分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="地摊详情" prop="shangpinxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinxiangqing" label="地摊详情" prop="shangpinxiangqing">
...
export default {
  data() {
	...
	price : false,
      ...
      rules: {
          shangpinmingcheng: [
                { required: true, message: '地摊名称不能为空', trigger: 'blur' },
          ],
          shangpinfenlei: [
                { required: true, message: '地摊分类不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          guige: [
  ...
  methods: {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springboot13f8n/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
